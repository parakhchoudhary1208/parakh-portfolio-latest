...
const vertexShader = `
  ...
  void main() {
    vUv = uv;
    float noise = snoise(vec3(position * uNoiseDensity + uTime * uSpeed + uMouse.x * 0.1));
    vDistort = noise;
...
const fragmentShader = `
  ...
  void main() {
    ...
    vec3 finalColor = mix(color1, color2, vDistort * 0.5 + 0.5 + uMouse.y * 0.1);
    gl_FragColor = vec4(finalColor, 0.15 + vDistort * 0.1);
  }
`;
